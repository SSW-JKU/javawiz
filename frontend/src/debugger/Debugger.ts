...
export class Debugger {
  ...
  public connect (): Promise<boolean> {
    return new Promise((resolve, reject) => {
      ...
      this.websocket.onmessage = (e: MessageEvent<string>) => this.handleMessage(e)
  ...
  public startCompilation (
    classContents: DebuggerProtocol.ClassContent[],
    excludeFromSteppingPatterns: string[] | undefined,
    excludeFieldsPatterns: string[] | undefined,
    detailedFieldsPatterns: string[] | undefined
  ) {
    if (this.compiling) {
      return
    }
  ...
  public step (request: DebuggerProtocol.StepRequest, replayStepPredicate: (stateIndex: number) => boolean): void {
