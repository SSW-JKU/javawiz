      ...
      <div :class="{'absolute-vertical-box': true, 'expanded': showAllLayouts}">
        <transition name="fullfade">
          <IconWithTooltip
            ...
            :icon="one"
            @action="() => visualizationStore.changeLayout(LAYOUT_ONE)" />
        </transition>
        <div class="float-container-center-aligned">
          <transition name="fullfade">
            <IconWithTooltip
              ...
              :icon="two_horizontal"
              @action="() => visualizationStore.changeLayout(LAYOUT_TWO_HORIZONTALSPLIT)" />
          </transition>
          <transition name="fullfade">
            <IconWithTooltip
              v-if="showAllLayouts"
              ...
              :icon="two_vertical"
              @action="() => visualizationStore.changeLayout(LAYOUT_TWO_VERTICALSPLIT)" />
          </transition>
        </div>
        <div class="float-container-center-aligned">
          <transition name="fullfade">
            <IconWithTooltip
              ...
              @action="() => visualizationStore.changeLayout(LAYOUT_THREE_RIGHTSINGLE)" />
          </transition>
          <transition name="fullfade">
            <IconWithTooltip
              v-if="showAllLayouts"
              ...
              @action="() => visualizationStore.changeLayout(LAYOUT_THREE_LEFTSINGLE)" />
          </transition>
        </div>
        <transition name="fullfade">
          <IconWithTooltip
            ...
            :icon="layout_four"
            @action="() => visualizationStore.changeLayout(LAYOUT_FOUR)" />
        </transition>
      </div>
    </div>
  </div>
...
const currentLayoutImageSource = computed(() => {
  switch (visualizationStore.currentLayout) {
