...
function highlightHoveredAndCurrentLine () {
  if (!editor) {
    return
  }
...
watch(() => generalStore.currentLine, () => {
  if (editor) {
    ...
    highlightHoveredAndCurrentLine()
  }
})
...
watch(hoveredLine, highlightHoveredAndCurrentLine)
watch(hoveredLineUri, highlightHoveredAndCurrentLine)
