...
export interface HeapVizHeapObject extends IHeapVizHeapItem {
  ...
  /** True if fields are for specialised visualisations only and must not be shown in the Memory View. */
  readonly detailedFieldsOnly: boolean
}
...
export interface HeapVizLoadedClass {
  ...
  /** True if static fields are for specialised visualisations only and must not be shown in the Memory View. */
  readonly detailedFieldsOnly: boolean
}
