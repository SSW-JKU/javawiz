...
public class InTest {
    ...
    private static final long[] longValues = new long[] {123, -45, 78987609012L, 0};
    private static final String[] identifiers = new String[] {"true", "java", "x2"};
    ...
    private static final String text = Arrays.stream(textLines).collect(Collectors.joining(LINE_SEPERATOR)) + LINE_SEPERATOR;
    private static final String[] strings = new String[] {"Hi", "two words", "ok", "invalid"};
