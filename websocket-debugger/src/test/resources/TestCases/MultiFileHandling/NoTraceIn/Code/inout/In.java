// This is a version of the In.java class which has been modified to allow visualization of the current state of the input buffer
// package inwiz;
package inout;
import java.io.*;
...
public class In {
	...
	// Do not delete unused method. Although not used by JDI backend, will be used by Espresso backend.
